...
class OtherPage10Mins : AppCompatActivity() {
    ...
    fun play(view: View?) {
        countDownTimer = MyCountDownTimer(600000, 1000)
    ...
    fun stop(view: View?) {
        countDownTimer!!.cancel()
        textView_timer!!.text = "10:00"
    }

    var button: Button? = null
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_exer_and_other_page10_mins)
