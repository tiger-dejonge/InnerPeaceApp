...
class OtherPage20Mins : AppCompatActivity() {
    ...
    fun play(view: View?) {
        countDownTimer = MyCountDownTimer(1200000, 1000)
    ...
    fun stop(view: View?) {
        countDownTimer!!.cancel()
        textView_timer!!.text = "20:00"
    }

    var button: Button? = null
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_exer_and_other_page20_mins)
